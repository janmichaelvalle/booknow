...
-- Run after business_packages is created.
...
drop trigger if exists business_package_pricing_set_updated_at
  on public.business_package_pricing;
  ...
  and not exists (
    ...
    where bpp.package_id = bp.id
      ...
      and (
        ...
        or (
          bpp.max_guests is null
          and seed.max_guests is null
        )
      )
  );